...
STEP 1:
  Create a slice of state called 'inputValue' and its 'setInputValue' buddy.  // OK Bro, jeeez, chill fam
...
export default function Input() {
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: (inputValue.length > 9)  ? 'royalblue' : 'crimson';
  };
  ...
  return (
    <div className='widget-input container'>
      ...
      <div>
        <input id='input' type='text' onChange={changeInput} /> {/* STEP 6 */ reset}
